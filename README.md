![nginx 1.9.6](https://img.shields.io/badge/nginx-1.9.6-brightgreen.svg) ![License MIT](https://img.shields.io/badge/license-MIT-blue.svg) [![Build Status](https://armdrone.strahlungsfrei.de/api/badges/armhf-docker-library/nginx-proxy/status.svg)](https://armdrone.strahlungsfrei.de/armhf-docker-library/nginx-proxy)
